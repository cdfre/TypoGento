...
class Wee_Typogento_Model_Replication_Manager {
	...
	public function registerProvider(Wee_Typogento_Model_Replication_Provider_Abstract $provider) {
		// get source model
	...
	/**
	 * 
	 * @see Wee_Typogento_Model_Replication_Provider_Abstract
	...
	protected function _update(Mage_Core_Model_Abstract $source, Mage_Core_Model_Abstract $target, Wee_Typogento_Model_Typo3_Replication_Link $link, $force = false) {
		// prefetch target 
