...
class Typogento_Core_Model_Observer {
	...
	public function replicationManagerInitialize(Varien_Event_Observer $observer) {
		...
		$customer = Mage::getModel('typogento/replication_provider_accounts', 
			Typogento_Core_Model_Replication_Provider_Accounts::PROVIDER_ID_MAGENTO_CUSTOMER
		);
		$user = Mage::getModel('typogento/replication_provider_accounts', 
			Typogento_Core_Model_Replication_Provider_Accounts::PROVIDER_ID_TYPO3_FRONTEND_USER
		);
