 ...
 */
class tx_weetypogento_pi1 extends tslib_pibase {
	 ...
	 * @var string
	 */
	public $prefixId = 'tx_weetypogento';
	
	/**
	 * @var string
	 */
	public $scriptRelPath = 'pi1/class.tx_weetypogento_pi1.php';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wee_typogento/pi1/class.tx_weetypogento_pi1.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wee_typogento/pi1/class.tx_weetypogento_pi1.php']);
}
