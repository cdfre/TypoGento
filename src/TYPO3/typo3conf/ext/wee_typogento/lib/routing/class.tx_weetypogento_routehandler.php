 ...
 */
interface tx_weetypogento_routeHandler {
 ...
 * @license http://opensource.org/licenses/gpl-license.php GNU Public License, version 2
 */
class tx_weetypogento_typolinkRouteHandler implements tx_weetypogento_routeHandler {
	...
	public function process() {
		...
		$this->_preservedHooks = $this->_replace($hooks, array('tx_weetypogento_typolinkRouteHandler.postProcessor'));
		$this->_replace($persistent['tx_weetypogento_typolinkRouteHandler.postProcessor'], $this->_postProcessing);
		// render typolink
		try {
		...
		$this->_replace($persistent['tx_weetypogento_typolinkRouteHandler.postProcessor'], null);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wee_typogento/lib/routing/class.tx_weetypogento_routehandler.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wee_typogento/lib/routing/class.tx_weetypogento_routehandler.php']);
}
