 ...
 */
class tx_typogento_cache implements t3lib_Singleton {
	...
	protected function _initializeCache() {
		...
		//
		try {
			$this->_handler = $GLOBALS['typo3CacheManager']->getCache('typogento');
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/typogento/lib/class.tx_typogento_cache.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/typogento/lib/class.tx_typogento_cache.php']);
}
