 ...
 */
class tx_typogento_sv2 extends tx_sv_auth {
	
	public $prefixId = 'tx_typogento_sv2';
	
	public $scriptRelPath = 'sv2/class.tx_typogento_sv2.php';
	...
	public function init() {
		...
		try {
			...
			$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_userauth.php']['postUserLookUp']['typogento_sv2'] =
				'EXT:typogento/sv2/class.tx_typogento_sv2.php:&tx_typogento_sv2->postUserLookUp';
		} catch (Exception $e) {
	...
	public function getUser() {
		...
		if (!$user->getId()) {
			...
			if (isset($customer) && $customer->getId()) {
				...
				// 
				unset($GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_userauth.php']['postUserLookUp']['typogento_sv2']);
			}
		} else {
			return $user->getData();
		}
