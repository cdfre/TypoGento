...
/**
 * TYPO3 Backend Module tx_typogento_modadmin
 *
...
class tx_typogento_modadmin  extends t3lib_SCbase {
	...
	protected function _load() {
		try {
			...
			$this->_user->setRoleIds(array($data['tx_typogento_group']));
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/typogento/mod_admin/index.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/typogento/mod_admin/index.php']);
}
